...
namespace RoyTekProjectSQL
{
    public partial class frmLogin : Form
    {
        ...
        private void btnExit_Click(object sender, EventArgs e)
        {
            ...
            {
                //this.loginresult = Globals.gLoginCloseApplication;
                this.Hide();

            }
            else
            {
                //this.loginresult = Globals.gLoginCannotEnter;
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    //Open SqlConnection
                    //MessageBox.Show(Globals.gsqlConnstr);
                    ...
                    SqlCommand cmd = new SqlCommand("Select TOP 1 id,loginname,password from USERS where LoginName=@LoginName and Active=1", Globals.sqlconn);
