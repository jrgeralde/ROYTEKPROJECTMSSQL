...
namespace RoyTekProjectSQL
{
    public partial class frmPriceCategories : Form
    {
        ...
        public void InitializeMainGrid()
        {
            ...
            this.dgvMain.Columns["name"].HeaderText = "Category Name";
            this.dgvMain.Columns["name"].Width = 200;


            this.dgvMain.Columns["description"].HeaderText = "Description    ";
            this.dgvMain.Columns["description"].Width = 330;
        }
        public void BindMainGrid()
        {
            if (Globals.glOpenSqlConn())
            {
                ...
                cmd.CommandText = "select id,name,description from pricecategories order by id ";
        ...
        private void dgvMain_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgvMain.CurrentRow != null)
            {
                if (Globals.glOpenSqlConn())
                {
                    ...
                    {
                        csMessageBox.Show("Please encode a valid category name", "Warning",
                    ...
                    else
                    {
                        try
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("exec dbo.spPriceCategoriesEdit " +
                                "@id=" + idval + ", " +
